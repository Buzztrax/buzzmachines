...
CMachineParameter const paraLFO1PhaseDiff =
{
        pt_byte,                                                                                // type
        "LFO1 Ph Diff",
        "Low Frequency Oscillator 1 Phase Difference: 00h=0ï¿½  40h=180ï¿½  7Fh=357ï¿½",
        0,                                                                                              // Min
        127,                                                                                    // Max
        0xff,                                                                                   // NoValue
        MPF_STATE,                                                                              // Flags
...
CMachineParameter const paraLFO2PhaseDiff =
{
        pt_byte,                                                                                // type
        "LFO2 Ph Diff",
        "Low Frequency Oscillator 2 Phase Difference: 00h=0ï¿½  40h=180ï¿½  7Fh=357ï¿½",
        0,                                                                                              // Min
        127,                                                                                    // Max
        0xff,                                                                                   // NoValue
        MPF_STATE,                                                                              // Flags
...
public:
        ...
        float OldOut; // gegen extreme Knackser/Wertesprï¿½nge
...
public:
        ...
        // Filter
        float *coefsTabOffs; // abhï¿½ngig vom FilterTyp
