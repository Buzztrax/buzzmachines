...
//		inL = inL - DcFilterL.Filter(inL, DcFrequency); // DC Filter
		...
		LoLevelL = LoLimiterL.Attack(LoLevelL, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//////////
		...
		MidLevelL = MidLimiterL.Attack(MidLevelL, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//////////
		...
		HiLevelL = HiLimiterL.Attack(HiLevelL, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//// Post Limit
		...
		PostLevelL = PostLimiterL.Decay(PostLevelL, 0.00011f); //400 ms at 44100 - needs to be tied to samplerate
		PostLevelL = PostLimiterL.Attack(PostLevelL, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//		inR = inR - DcFilterR.Filter(inR, DcFrequency); //DC Filter
		...
		LoLevelR = LoLimiterR.Attack(LoLevelR, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//////////
		...
		MidLevelR = MidLimiterR.Attack(MidLevelR, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//////////
		...
		HiLevelR = HiLimiterR.Attack(HiLevelR, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
...
//// Post Limit
		...
		PostLevelR = PostLimiterR.Decay(PostLevelR, 0.00011f); //400 ms at 44100 - needs to be tied to samplerate
		PostLevelR = PostLimiterR.Attack(PostLevelR, 0.0443459f); //1 ms at 44100 - needs to be tied to samplerate
