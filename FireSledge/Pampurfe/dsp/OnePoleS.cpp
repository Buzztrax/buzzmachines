...
void	OnePoleS::transform_s_to_z ()
{
	using namespace std;
	using basic::is_null;
	using basic::PI;
	...
	const double	b1z = _s_eq_b [0] - b1k;
	const double	b0z = _s_eq_b [0] + b1k;

	const double	a1k = _s_eq_a [1] * k;
	const double	a1z = _s_eq_a [0] - a1k;
	const double	a0z = _s_eq_a [0] + a1k;
